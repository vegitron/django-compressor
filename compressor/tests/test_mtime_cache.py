...
class TestMtimeCacheCommand(TestCase):
    ...
    def test_handle_add(self):
        ...
        output = out.getvalue()
        self.assertIn('Deleted mtimes of 22 files from the cache.', output)
        self.assertIn('Added mtimes of 22 files to cache.', output)
    ...
    def test_handle_clean(self):
        ...
        output = out.getvalue()
        self.assertIn('Deleted mtimes of 22 files from the cache.', output)
        self.assertNotIn('Added mtimes of 22 files to cache.', output)
